export const SERVICES = [
  {
    description:
      'llorem ipsum dolor sit amet consectetur dima adipisicing elit. Quisquam, quae faucibus ex sapien vitae pellentesque sem placerat. In id cursus mi pretium tellus duis convallis.',
